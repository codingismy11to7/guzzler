...
export class RawCurrentSession_DoNotUse extends Context.Tag("RawCurrentSession_DoNotUse")<
  RawCurrentSession_DoNotUse,
  Session
>() {}
export class CurrentUnknownUserSession extends Context.Tag("CurrentUnknownUserSession")<
  CurrentUnknownUserSession,
  UnknownUserSession
>() {}
export class CurrentFullSession extends Context.Tag("CurrentFullSession")<CurrentFullSession, UserSession>() {}

export class RequireNewUserSession extends HttpApiMiddleware.Tag<RequireNewUserSession>()("RequireNewUserSession", {
...
export class RequireFullSession extends HttpApiMiddleware.Tag<RequireFullSession>()("RequireFullSession", {
  failure: Schema.Union(Unauthorized, Forbidden),
...
export class AuthRedirectMiddleware extends HttpApiMiddleware.Tag<AuthRedirectMiddleware>()("AuthRedirectMiddleware", {
  optional: false,
}) {}
